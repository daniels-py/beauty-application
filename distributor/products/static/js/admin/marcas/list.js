...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            let tbody = $('#marcas-tbody');  // Seleccionamos el tbody de la tabla donde se insertarán los datos
            ...
            data.forEach(marcas => {
                ...
                tbody.append(`
                    <tr>
                        <td>${marcas.id}</td>  <!-- Mostrar el ID de la categoría -->
                        <td>${marcas.nombre}</td>  <!-- Mostrar el nombre de la categoría -->
                        <!-- Agregar botones de acción para actualizar y eliminar -->
                        <td>
                            <button class="btn-actualizar" data-id="${marcas.id}">Actualizar</button>
                            <button class="btn-eliminar" data-id="${marcas.id}">Eliminar</button>
                        </td>
                    </tr>
                `);
            });
