...
SECRET_KEY = 'django-insecure-gt4vai6a0p=f+=6^ec%yc!@hyc&z$sfkp-ip6#ou+s5qr6du#='
...
INSTALLED_APPS = [
    ...
    #  Mis Aplicaciones personalizadas versioon base refactor
    'users',
    'products',
    'inventory',
    'store',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'distibutor', #nombre de la base de datos
